...
class ObSysVarFetchTablesPlan : public ObEnumSysVar
{
public:
  const static char * FETCH_TABLES_PLAN_NAMES[];
public:
  ObSysVarFetchTablesPlan() : ObEnumSysVar(FETCH_TABLES_PLAN_NAMES, NULL, NULL, NULL, NULL, NULL) {}
  inline virtual ObSysVarClassType get_type() const { return SYS_VAR_FETCH_TABLES_PLAN; }
