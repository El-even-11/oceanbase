...
int ObInnerTableSchema::all_virtual_os_process_schema(ObTableSchema &table_schema)
{
  int ret = OB_SUCCESS;
  ...
  table_schema.set_table_id(OB_ALL_VIRTUAL_OS_PROCESS_TID);
  ...
  if (OB_SUCC(ret)) {
    if (OB_FAIL(table_schema.set_table_name(OB_ALL_VIRTUAL_OS_PROCESS_TNAME))) {
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("pid", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("cpu", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("mem", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("vsz", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("rss", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("cmd", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
